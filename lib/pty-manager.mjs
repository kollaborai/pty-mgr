        ...
        while ((nl = buf.indexOf("\n")) !== -1) {
          ...
          try {
            ...
            if (req.cmd === "attach") {
              ...
              // switch client to alternate screen (preserves their scrollback)
              conn.write("\x1b[?1049h\x1b[H\x1b[2J");
              // dump full scrollback history, not just visible rows
              const screen = session.capture(0);
  ...
  return new Promise((resolve, reject) => {
    ...
    conn.on("connect", () => {
      ...
      function detach() {
        ...
        // pop back to normal screen buffer
